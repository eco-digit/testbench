...
The following sections mention the **ECO:DIGIT Score**. This is an independently developed metric, which is explained in more depth in the corresponding document.
